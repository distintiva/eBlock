...
public class TabsPart extends UIPart {
	...
	public function TabsPart(app:eBlock) {
		this.app = app;
	...
	public static function makeTab(label:String, action:Function):IconButton {
		return new IconButton(action, makeTabImg(label, true), makeTabImg(label, false), true);
	}

	public static  function makeTabImg(label:String, isSelected:Boolean):Sprite {
