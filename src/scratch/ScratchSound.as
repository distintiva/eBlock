...
eBlock.app.log('Converting MP3 to WAV: ' + soundName);
			md5 = null;
...
eBlock.app.log('Converting squeak sound to WAV ADPCM; sampleCount old: ' + sampleCount + ' new: ' + (uncompressedData.length / 2));
