...
public class FunctionVideoMotion {
	...
	private function primVideoMotion(thread:Thread, argList:Array):void {
		...
		var obj:ScratchObj = eBlock.app.stagePane.objNamed(String(argList[1]));
	...
	private function startMotionDetector():void { eBlock.app.runtime.motionDetector = this }
	private function stopMotionDetector():void { eBlock.app.runtime.motionDetector = null }

	public function step():void {
		frameNum++;
		var sprites:Array = eBlock.app.stagePane.sprites();
		if (!(eBlock.app.stagePane && eBlock.app.stagePane.videoImage)) {
			prev = curr = null;
		...
		var img:BitmapData = eBlock.app.stagePane.videoImage.bitmapData;
