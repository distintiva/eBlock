package cc.customcode.uibot.uiwidgets.extensionMgr
{
	...
	import cc.customcode.uibot.uiwidgets.extensionMgr.DefaultListCell;
	...
	internal class ExtensionMgrFrame extends MyFrame
	{
		...
		{
			var result:Array = [];
			for each(var ext:Object in eBlock.app.extensionManager.extensionList){
				...
				var obj:Object = {name:ext.extensionName||"",description:ext.description||"",version:ext.version||"",author:author,authorLink:authorLink,homepage:ext.homepage||"",isExtensionBoard:ext.isExtensionBoard};
