package cc.customcode.uibot.util
{
	...
	import cc.customcode.uibot.uiwidgets.extensionMgr.DefaultLabel;
	...
	public class PopupUtil
	{
		...
		static public function appendInfo(cmp:JOptionPane,title:String):void
		{
			var label:DefaultLabel = new DefaultLabel(true, true);
			
			label.setLabel(title);
			
			label.htmlText.width = 390;
			
			label.htmlText.setTextFormat( new TextFormat(CSS.font, 12) );
