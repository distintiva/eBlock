...
public class IconButton extends Sprite {
	...
	private var _onColor:int;
	private var _offColor:int;
	private var _dropDownArrow:Boolean;
	...
	public function setLabelOnly(s:String ):void {
		// Set my off/on images to the given string and colors.
		// If dropDownArrow, add a drop-down arrow after the label.
		setImage(
			makeLabelSprite(s, _offColor, _dropDownArrow),
			makeLabelSprite(s, _onColor, _dropDownArrow));
		isMomentary = true;
	}
