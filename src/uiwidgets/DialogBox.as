...
public class DialogBox extends Sprite {
	...
	public static function ask(question:String, defaultAnswer:String, stage:Stage = null, resultFunction:Function = null):void {
		...
		d.showOnStage(stage ? stage : eBlock.app.stage);
	}
...
//		result.text = s;
	...
	private function drawBackground():void {
		var titleBarColors:Array = CSS.titleBarColors;//[0xE0E0E0, 0xD0D0D0]; // old: CSS.titleBarColors;
		var borderColor:int =CSS.borderColor;// 0xB0B0B0; // old: CSS.borderColor;
