...
//		if((MBlock_mod.app.isIn3D || Capabilities.cpuArchitecture != 'x86') && !force) return [];

		var scale:Number = targetObj.isStage ? 1 : eBlock.app.stagePane.scaleX;
		...
		if (filterDict["pixelate"] != 0) {
			...
			if (targetObj == eBlock.app.stagePane) n *= eBlock.app.stagePane.scaleX;
