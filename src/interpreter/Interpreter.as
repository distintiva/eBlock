...
//	private var workTime:int;
	...
	public function Interpreter(app:eBlock) {
		this.app = app;
//		initPrims();
	...
	public function runThread(b:Block, targetObj:ScratchObj):Thread
	{
		...
		thread.finishSignal.add(function(isInterput:Boolean):void{
			...
			switch(b.type.toLowerCase()){
				case "r":
					eBlock.app.showBubble(thread.resultValue, p.x, p.y, b.width);
					break;
				case "b":
					eBlock.app.showBubble(Boolean(thread.resultValue).toString(), p.x, p.y, b.width);
					break;
			}
		}, true);
		b.showRunFeedback();
