...
public class Specs {
	...
	public static const categoriesExtensions:Array = [1,2,3,5,7]; //*JC*- Categorias donde pueden entrar parte de las extensiones
	...
	public static const extensionsColor:uint = 0x5E9CFB;//0x75980a;//0x98980a//0x98510a;
//0x2980b9;//0x4B4A60; // 0x72228C; // 0x672D79;
	...
	private static const blockSpecXML:Class;
	
	[Embed(source="assets/menu.xml", mimeType="application/octet-stream")]
	public static const topMenuXML:Class;
	
	[Embed(source="assets/context_menus.xml", mimeType="application/octet-stream")]
	public static const contextMenusXML:Class;
	
	[Embed(source="assets/html/index.html", mimeType="application/octet-stream")]
	public static const arduinoHtmlPanel:Class;
	
	[Embed(source="assets/html/info.html", mimeType="application/octet-stream")]
	public static const infoHtmlPanel:Class;
	
	[Embed(source="assets/html/console.html", mimeType="application/octet-stream")]
	public static const consoleHtmlPanel:Class;
	...
	static private function Init():void
	{
		...
		var bytes:ByteArray = new blockSpecXML();
